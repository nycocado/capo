...
export function useWeldOperations({
  ...
  const processWeld = useCallback(
    async (weldId: number, wpsId: number, fillerMaterialId: number) => {
      return performOperation(
        API_ROUTES.weld.welding,
        {
          weldId,
          wpsId,
          fillerMaterialId,
  ...
  const editWps = useCallback(
    async (weldId: number, wpsId: number) => {
      return performOperation(
        API_ROUTES.weld.editWps,
        {
          weldId,
          wpsId,
        },
  ...
  const editFillerMaterial = useCallback(
    async (weldId: number, fillerMaterialId: number) => {
      return performOperation(
        API_ROUTES.weld.editFillerMaterial,
        {
          weldId,
          fillerMaterialId,
        },
